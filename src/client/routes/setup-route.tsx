...
export function Component() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="sticky top-0 z-50 bg-[var(--background)]/85 backdrop-blur-md border-b border-[var(--border)] flex items-center justify-between gap-2 px-4 py-3 sm:px-6 transition-all duration-300">
        <Link
          to="/"
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              {setupStatus.folderPickerAvailable && (
                <button
                  ...
                  className="shrink-0 rounded-xl bg-gradient-to-r from-purple-700 to-rose-600 hover:from-purple-800 hover:to-rose-700 px-4 py-2.5 text-sm font-medium text-white shadow-md hover:shadow-lg transition-all active:scale-95 disabled:cursor-wait disabled:opacity-60"
                >
          ...
          <button
            ...
            className="w-full rounded-xl bg-gradient-to-r from-purple-700 to-rose-600 hover:from-purple-800 hover:to-rose-700 px-5 py-3 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-all active:scale-95 disabled:cursor-wait disabled:opacity-60"
          >
            {primaryActionLabel}
          </button>
